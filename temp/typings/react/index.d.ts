...
declare module "react" {
    ...
    export type InputIdentityList = ReadonlyArray<any>;
     ...
     */
    export function  useReducer<S, A>(reducer: Reducer<S, A>, initialState: S, initialAction?: A | null): [S, Dispatch<A>];
    /**
     ...
     */
    export function  useMutationEffect(effect: EffectCallback, inputs?: InputIdentityList): void;
    /**
     ...
     */
    export function  useLayoutEffect(effect: EffectCallback, inputs?: InputIdentityList): void;
    /**
     ...
     */
    export function  useEffect(effect: EffectCallback, inputs?: InputIdentityList): void;
     ...
     */
    export function  useImperativeMethods<T, R extends T>(ref: Ref<T>|undefined, init: () => R, inputs?: InputIdentityList): void;
    ...
    export function  useCallback<T extends (...args: any[]) => any>(callback: T, inputs: InputIdentityList): T;
    /**
