(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ReactArcher"] = factory(require("react"), require("prop-types"));
	else
		root["ReactArcher"] = factory(root["React"], root["PropTypes"]);
...
var _ArcherElement = __webpack_require__(3);

Object.defineProperty(exports, 'ArcherElement', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_ArcherElement).default;
  }
});

var _ArcherContainer = __webpack_require__(4);

Object.defineProperty(exports, 'ArcherContainer', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_ArcherContainer).default;
  }
});
...
var _resizeObserverPolyfill = __webpack_require__(5);
...
var _SvgArrow = __webpack_require__(8);
...
var ArcherContainer = exports.ArcherContainer = function (_React$Component) {
  ...
  function ArcherContainer(props) {
    ...
    _this.registerTransition = _this.registerTransition.bind(_this);
    _this.registerChild = _this.registerChild.bind(_this);
    _this.storeParent = _this.storeParent.bind(_this);
    _this.refreshScreen = _this.refreshScreen.bind(_this);
    _this.state = {
      refs: {},
      fromTo: []
    };
  ...
  _createClass(ArcherContainer, [{
    ...
    key: 'storeParent',
    value: function storeParent(ref) {
    ...
    key: 'getRectFromRef',
    value: function getRectFromRef(ref) {
      if (!ref) {
        return new _Point2.default(0, 0);
      }
    ...
    value: function getParentCoordinates() {
      var rectp = this.getRectFromRef(this.state.parent);
      return rectToPoint(rectp);
    }
  }, {
    key: 'getPointCoordinatesFromAnchorPosition',
    value: function getPointCoordinatesFromAnchorPosition(position, index, parentCoordinates) {
      var rect = this.getRectFromRef(this.state.refs[index]);
    ...
    value: function registerTransition(fromElement, relation) {
      var _this2 = this;

      var fromTo = [].concat(_toConsumableArray(this.state.fromTo));
      var newFromTo = _extends({}, relation, { from: _extends({}, relation.from, { id: fromElement }) });
      fromTo.push(newFromTo);
      this.setState(function (currentState) {
        return _extends({}, _this2.currentState, { fromTo: [].concat(_toConsumableArray(currentState.fromTo), _toConsumableArray(fromTo)) });
      });
    }
  }, {
    key: 'registerChild',
    value: function registerChild(id) {
      ...
      return function (ref) {
        if (!_this3.state.refs[id]) {
          var ro = new _resizeObserverPolyfill2.default(function () {
            _this3.refreshScreen();
          });
          ro.observe(ref);
          _this3.setState(function (currentState) {
            return _extends({}, _this3.currentState, { refs: _extends({}, currentState.refs, _defineProperty({}, id, ref)) });
          });
        }
      };
    }
    ...
    key: 'computeArrows',
    value: function computeArrows() {
      var _this4 = this;

      var parentCoordinates = this.getParentCoordinates();
      return this.state.fromTo.map(function (sd) {
        var startingAnchor = sd.from.anchor;
        var startingPoint = _this4.getPointCoordinatesFromAnchorPosition(sd.from.anchor, sd.from.id, parentCoordinates);
        var endingAnchor = sd.to.anchor;
        var endingPoint = _this4.getPointCoordinatesFromAnchorPosition(sd.to.anchor, sd.to.id, parentCoordinates);
        return _react2.default.createElement(_SvgArrow2.default, {
          ...
          strokeColor: _this4.props.strokeColor,
          arrowLength: _this4.props.arrowLength
        });
      });
    }
  }, {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { ref: this.storeParent, style: style },
          this.props.children
        )
      );
    }
...
function computeEndingPointAccordingToArrow(xEnd, yEnd, arrowLength, endingAnchor) {
  ...
  var xe = xEnd + arrowX * arrowLength;
  var ye = yEnd + arrowY * arrowLength;
...
var SvgArrow = function SvgArrow(_ref) {
  ...
  var _computeEndingPointAc = computeEndingPointAccordingToArrow(endingPoint.x, endingPoint.y, actualArrowLength, endingAnchor),
