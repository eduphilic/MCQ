...
var babel_preset_react_app_1 = __importDefault(
  require("@strothj/babel-preset-react-app"),
);
var preset_typescript_1 = __importDefault(require("@babel/preset-typescript"));
var plugin_transform_typescript_1 = __importDefault(
...
var removeFlowPreset = function() {
  ...
  preset.presets = preset.presets.filter(function(p) {
    return !babelPluginTransformFlowDetectionHack(p);
  });
