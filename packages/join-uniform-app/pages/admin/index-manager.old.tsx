    ...
    <UpdateIndexPageComponent>
      {updateIndexPage =>
        withQueryLoadingSpinner(
          GetIndexPageConfigComponent,
          ({ data: { logoConfig, indexPageConfig, indexCards }, refetch }) => (
            <Formik<FormValues>
              initialValues={{
              ...
              onSubmit={async values => {
                const request: InputIndexPageConfigUpdate = {
                  logoUrl: values.logoUrl,
                  heroBackgroundImageUrl: values.heroBackgroundImageUrl,
                  heroBackgroundAlpha: values.heroBackgroundAlpha,
                  heroPrimaryTextEnglish: values.heroPrimaryTextEnglish,
                  heroPrimaryTextHindi: values.heroPrimaryTextHindi || null,
                  heroFeatures: values.heroFeatures.map(h => ({
                    en: h.en,
                    hi: h.hi,
                  })),
                  aboutTitleEnglish: values.aboutTitleEnglish,
                  aboutTitleHindi: values.aboutTitleHindi || null,
                  aboutTextEnglish: values.aboutTextEnglish,
                  aboutTextHindi: values.aboutTextHindi || null,
                  aboutImages: values.aboutImages.map(a => ({
                    imageUrl: a.imageUrl,
                    title: {
                      en: a.title.en,
                      hi: a.title.hi,
                  ...
                  indexCards: values.indexCards.map(i => ({
                    entryId: i.entryId,
                    categories: i.categories.map(c => ({
                      categoryId: c.categoryId,
                      visible: c.visible,
                    })),
                    colorBlock: i.colorBlock,
                    colorCategoryBackground: i.colorCategoryBackground,
                    colorLogoBackground: i.colorLogoBackground,
                    colorTitle: i.colorTitle,
                  })),
                };

                await updateIndexPage({ variables: { request } });
                await refetch();
              }}
