...
export namespace HtmlConfigResolvers {
  export interface Resolvers<Context = any, TypeParent = HtmlConfig> {
    /** Google Analytics ID. */
...
export namespace IndexPageConfigResolvers {
  export interface Resolvers<Context = any, TypeParent = IndexPageConfig> {
    /** The url to the hero image. */
...
export namespace IndexPageAboutImageResolvers {
  export interface Resolvers<Context = any, TypeParent = IndexPageAboutImage> {
    /** Image URL. */
...
export namespace AdminLoginPageConfigResolvers {
  export interface Resolvers<Context = any, TypeParent = AdminLoginPageConfig> {
    heroPrimaryText?: HeroPrimaryTextResolver<
      LocalizedString,
      TypeParent,
      Context
...
export namespace SessionFormConfigResolvers {
  export interface Resolvers<Context = any, TypeParent = SessionFormConfig> {
